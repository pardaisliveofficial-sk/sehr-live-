...
let FIRESTORE_DB_ID = "ai-studio-pardaisparty-472fb6a7-1901-43d4-8fd3-710376199072";
...
export const dbDataCache: any = {
  user: {
    username: "Prince_Pardais",
    uniqueId: "pardais_8899",
    avatar: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=150&h=150&q=80",
    coverPhoto: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=800&q=80",
    bio: "Pardais Party VIP 👑 Support is everything! Family Creator & Diamond Earner.",
    gender: "Male",
    country: "Pakistan",
...
export async function checkAndSeedDatabase() {
  ...
  try {
    ...
    const jsonPath = path.join(process.cwd(), "pardais_live_db.json");
